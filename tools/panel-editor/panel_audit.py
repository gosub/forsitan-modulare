...
RECT_OVERRIDE = {'VCVSlider': (3.36, 12.96), 'VCVLightSlider': (3.36, 12.96),
                 ...
                 # click-to-position variants (src/position_switch.hpp), same
                 # bodies as the switches they wrap
                 'CKSSPos': (2.0, 5.0), 'CKSSThreePos': (2.0, 5.0)}
...
def audit(path):
    ...
    issues = []
    # title bbox
    title_sz, title_base, title_w = ns['title_metrics'](data, text_w)
