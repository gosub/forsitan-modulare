...
struct Materiae : Module {
    ...
    float levelEnv = 0.f, hitLight = 0.f;
    int velCount = 0;
    float velPeak = 0.f;
    int controlPhase = 0;
    ...
    void process(const ProcessArgs& args) override {
        ...
        float audio, env2;
        engine.process(p, args.sampleTime, audio, env2, e2Pitch, e2Rel, e2Cut,
                       voct);
...
// @layout:begin materiae 101.6 128.5
...
// @elem LABEL_PITCH label 0.0 label "pitch" 0.0 10.16 29.50
// @elem LABEL_RATIO label 0.0 label "ratio" 0.0 30.48 29.50
// @elem LABEL_SHAPE label 0.0 label "shape" 0.0 50.80 29.50
// @elem LABEL_GRID label 0.0 label "grid" 0.0 71.12 29.50
// @elem LABEL_DIV label 0.0 label "div" 0.0 91.44 29.50
// @elem LABEL_XMOD label 0.0 label "xmod" 0.0 10.16 53.50
// @elem LABEL_TILT label 0.0 label "tilt" 0.0 30.48 53.50
// @elem LABEL_DEST label 0.0 label "dest" 0.0 50.80 53.50
// @elem LABEL_RELATION label 0.0 label "relation" 0.0 71.12 53.50
// @elem LABEL_BLEND label 0.0 label "blend" 0.0 91.44 53.50
// @elem LABEL_CUTOFF label 0.0 label "cutoff" 0.0 10.16 77.50
// @elem LABEL_RESO label 0.0 label "reso" 0.0 30.48 77.50
// @elem LABEL_FILTER label 0.0 label "lp/bp" 0.0 50.80 77.50
// @elem LABEL_DECAY2 label 0.0 label "dec 2" 0.0 71.12 77.50
// @elem LABEL_CURVE2 label 0.0 label "crv 2" 0.0 91.44 77.50
// @elem LABEL_ATTACK label 0.0 label "att" 0.0 10.16 98.50
// @elem LABEL_DECAY label 0.0 label "dec" 0.0 30.48 98.50
// @elem LABEL_CURVE label 0.0 label "crv" 0.0 50.80 98.50
// @elem LABEL_E2 label 0.0 label "env 2 to" 0.0 80.00 84.00
// @elem LABEL_E2PITCH label 0.0 label "pit" 0.0 68.00 96.50
// @elem LABEL_E2REL label 0.0 label "rel" 0.0 80.00 96.50
// @elem LABEL_E2CUT label 0.0 label "cut" 0.0 92.00 96.50
// @elem LABEL_HIT label 0.0 label "hit" 0.0 7.00 112.50
// @elem LABEL_TRIG label 0.0 label "trig" 0.0 17.00 112.50
// @elem LABEL_VOCT label 0.0 label "v/o" 0.0 26.60 112.50
// @elem LABEL_RATIOCV label 0.0 label "rat" 0.0 36.20 112.50
// @elem LABEL_XMODCV label 0.0 label "xmd" 0.0 45.80 112.50
// @elem LABEL_RELCV label 0.0 label "rel" 0.0 55.40 112.50
// @elem LABEL_CUTCV label 0.0 label "cut" 0.0 65.00 112.50
// @elem BOX_ENV2 panel_box 7.0 box "" 0.0 78.00 107.00
// @elem BOX_AUDIO panel_box 7.0 box "" 0.0 93.50 107.00
// @elem LABEL_ENV2 label 0.0 label "env" 0.0 78.00 112.50
// @elem LABEL_AUDIO label 0.0 label "out" 0.0 93.50 112.50
// @elem LOGO forsitan_logo 0.0 logo "" 0.0 50.80 122.50
        ...
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(10.16f, 21.00f)), module, Materiae::PITCH_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(30.48f, 21.00f)), module, Materiae::RATIO_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(50.80f, 21.00f)), module, Materiae::SHAPE_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(71.12f, 21.00f)), module, Materiae::GRID_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(91.44f, 21.00f)), module, Materiae::DIV_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(10.16f, 45.00f)), module, Materiae::XMOD_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(30.48f, 45.00f)), module, Materiae::TILT_PARAM));
        addParam(createParamCentered<CKSSThree>(mm2px(Vec(50.80f, 45.00f)), module, Materiae::DEST_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(71.12f, 45.00f)), module, Materiae::RELATION_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(91.44f, 45.00f)), module, Materiae::BLEND_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(10.16f, 69.00f)), module, Materiae::CUTOFF_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(30.48f, 69.00f)), module, Materiae::RESO_PARAM));
        addParam(createParamCentered<CKSS>(mm2px(Vec(50.80f, 69.00f)), module, Materiae::FILTER_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(71.12f, 69.00f)), module, Materiae::DECAY2_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(91.44f, 69.00f)), module, Materiae::CURVE2_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(10.16f, 90.00f)), module, Materiae::ATTACK_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(30.48f, 90.00f)), module, Materiae::DECAY_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(50.80f, 90.00f)), module, Materiae::CURVE_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(68.00f, 90.00f)), module, Materiae::E2PITCH_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(80.00f, 90.00f)), module, Materiae::E2REL_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(92.00f, 90.00f)), module, Materiae::E2CUT_PARAM));
        ...
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(26.60f, 105.00f)), module, Materiae::VOCT_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(36.20f, 105.00f)), module, Materiae::RATIO_CV_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(45.80f, 105.00f)), module, Materiae::XMOD_CV_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(55.40f, 105.00f)), module, Materiae::RELATION_CV_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(65.00f, 105.00f)), module, Materiae::CUTOFF_CV_INPUT));
        addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(78.00f, 105.00f)), module, Materiae::ENV2_OUTPUT));
        addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(93.50f, 105.00f)), module, Materiae::AUDIO_OUTPUT));
        addChild(createLightCentered<SmallLight<GreenLight>>(mm2px(Vec(11.50f, 102.00f)), module, Materiae::HIT_LIGHT));
        addChild(createLightCentered<SmallLight<GreenLight>>(mm2px(Vec(83.00f, 102.00f)), module, Materiae::ENV2_LIGHT));
        addChild(createLightCentered<SmallLight<GreenLight>>(mm2px(Vec(98.50f, 102.00f)), module, Materiae::LEVEL_LIGHT));
        // @layout:end
    }
