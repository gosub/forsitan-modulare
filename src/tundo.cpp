...
// @elem LOGO forsitan_logo 0.0 logo "" 0.0 35.56 122.50
        ...
        addParam(createParamCentered<Trimpot>(mm2px(Vec(9.46f, 35.50f)), module, Tundo::PITCH_ATT_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(26.86f, 35.50f)), module, Tundo::HARM_ATT_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(44.26f, 35.50f)), module, Tundo::SPREAD_ATT_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(61.66f, 35.50f)), module, Tundo::MORPH_ATT_PARAM));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(9.46f, 44.50f)), module, Tundo::PITCH_CV_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(26.86f, 44.50f)), module, Tundo::HARM_CV_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(44.26f, 44.50f)), module, Tundo::SPREAD_CV_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(61.66f, 44.50f)), module, Tundo::MORPH_CV_INPUT));
        ...
        addParam(createParamCentered<Trimpot>(mm2px(Vec(18.16f, 71.50f)), module, Tundo::FOLD_ATT_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(35.56f, 71.50f)), module, Tundo::ATTACK_ATT_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(52.96f, 71.50f)), module, Tundo::DECAY_ATT_PARAM));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(18.16f, 80.50f)), module, Tundo::FOLD_CV_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(35.56f, 80.50f)), module, Tundo::ATTACK_CV_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(52.96f, 80.50f)), module, Tundo::DECAY_CV_INPUT));
