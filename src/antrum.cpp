...
// @elem LABEL_DEPTH label 0.0 label "depth" 0.0 14.80 70.50
// @elem LABEL_SPEED label 0.0 label "speed" 0.0 38.80 70.50
// @elem LABEL_TILT label 0.0 label "tilt" 0.0 62.80 70.50
// @elem LABEL_MIX label 0.0 label "mix" 0.0 86.80 70.50
...
// @elem LOGO forsitan_logo 0.0 logo "" 0.0 50.80 122.50
        ...
        addParam(createParamCentered<Trimpot>(mm2px(Vec(14.80f, 39.50f)), module, Antrum::SIZE_ATT_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(38.80f, 39.50f)), module, Antrum::PREDELAY_ATT_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(62.80f, 39.50f)), module, Antrum::DECAY_ATT_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(86.80f, 39.50f)), module, Antrum::ABSORB_ATT_PARAM));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(14.80f, 48.50f)), module, Antrum::SIZE_CV_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(38.80f, 48.50f)), module, Antrum::PREDELAY_CV_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(62.80f, 48.50f)), module, Antrum::DECAY_CV_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(86.80f, 48.50f)), module, Antrum::ABSORB_CV_INPUT));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(14.80f, 62.00f)), module, Antrum::DEPTH_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(38.80f, 62.00f)), module, Antrum::SPEED_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(62.80f, 62.00f)), module, Antrum::TILT_PARAM));
        addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(86.80f, 62.00f)), module, Antrum::MIX_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(14.80f, 76.50f)), module, Antrum::DEPTH_ATT_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(38.80f, 76.50f)), module, Antrum::SPEED_ATT_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(62.80f, 76.50f)), module, Antrum::TILT_ATT_PARAM));
        addParam(createParamCentered<Trimpot>(mm2px(Vec(86.80f, 76.50f)), module, Antrum::MIX_ATT_PARAM));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(14.80f, 85.50f)), module, Antrum::DEPTH_CV_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(38.80f, 85.50f)), module, Antrum::SPEED_CV_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(62.80f, 85.50f)), module, Antrum::TILT_CV_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(86.80f, 85.50f)), module, Antrum::MIX_CV_INPUT));
