...
| **gain a / gain b** | bank balance, 0–2 (CV-able). These are not just a mix: together with **level** they set the total feedback gain, and below roughly `gain a + gain b = 1.5` the Duffing settles onto a fixed point and guttur becomes a static drone. If it sounds dead, turn these *up* |
